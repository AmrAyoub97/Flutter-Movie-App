...
class Movie {
  ...
  static List<Movie> listFromJson(Map<String, dynamic> jsonn) {
    try {
      var moviesList = new List<Movie>();
      ApiProvider _provider = new ApiProvider();
      jsonn['results'].forEach((movie) async {
        var id = movie["id"];
        final mov = await _provider.get(id.toString());
        final vid = await _provider.get(id.toString() + "/videos");
        Movie m = new Movie.fromJson(mov);
        m.videoId = getVideoId(vid);
        moviesList.add(m);
      });
      return moviesList;
    } catch (error) {
  ...
  static String getVideoId(Map<String, dynamic> json) {
    String s = '';
