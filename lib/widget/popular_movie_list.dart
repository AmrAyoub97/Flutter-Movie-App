...
class _GetMovieState extends State<PopularMovieList> {
  MovieBloc _bloc;

  @override
  void initState() {
    super.initState();
    _bloc = MovieBloc('popular');
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: RefreshIndicator(
        onRefresh: () => _bloc.fetchMovie('popular'),
              ...
              switch (snapshot.data.status) {
                ...
                case Status.ERROR:
                  return Error(
                    ...
                    onRetryPressed: () => _bloc.fetchMovie('popular'),
                  );
                  break;
              }
            }
      ...
      itemBuilder: (context, index) {
        return Container(
          ...
          child: GestureDetector(
            onTap: () {
              print('main' + movieList[index].id.toString());
